...
import { AvailabilityCounter } from "@/features/settings/components/availability-counter";
...
export const Route = createFileRoute("/_app/settings")({
  ...
  component: () => <SettingsLayout counters={{ "/settings/availability": <AvailabilityCounter /> }} />,
});
